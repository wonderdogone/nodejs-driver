 ...
 * @param {Function} callback
 */
SchemaParser.prototype.getMaterializedView = function (cc, keyspace, name, callback) {
...
/** @override */
SchemaParserV1.prototype.getMaterializedView = function (cc, keyspace, name, callback) {
...
/** @override */
SchemaParserV2.prototype.getMaterializedView = function (cc, keyspace, name, callback) {
  var viewInfo = keyspace.views[name];
  if (!viewInfo) {
    keyspace.views[name] = viewInfo = new MaterializedView(name);
  }
  if (viewInfo.loaded) {
